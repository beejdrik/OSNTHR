...
g.addEdge(20, 30, 0);  g.addEdge(30, 20, 1);
...
g.addEdge(90, 100, 5); g.addEdge(100, 90, 1);
...
g.addEdge(21, 31, 0); g.addEdge(31, 21, 1);
g.addEdge(31, 41, 0); g.addEdge(41, 31, 0);
g.addEdge(41, 51, 0); g.addEdge(51, 41, 0);
g.addEdge(51, 61, 1); g.addEdge(61, 51, 0);
g.addEdge(61, 71, 1); g.addEdge(71, 61, 1);
g.addEdge(71, 81, 1); g.addEdge(81, 71, 1);
g.addEdge(81, 91, 5); g.addEdge(91, 81, 1);
g.addEdge(91, 101, 10); g.addEdge(101, 91, 5);
g.addEdge(101, 111, 5); g.addEdge(111, 101, 10);
g.addEdge(111, 121, 1); g.addEdge(121, 111, 5);
g.addEdge(121, 131, 1); g.addEdge(131, 121, 1);
g.addEdge(131, 141, 3); g.addEdge(141, 131, 1);

    // Column 2
g.addEdge(2, 12, 1);   g.addEdge(12, 2, 5);
g.addEdge(12, 22, 1);  g.addEdge(22, 12, 1);
g.addEdge(22, 32, 1);  g.addEdge(32, 22, 1);
g.addEdge(32, 42, 1);  g.addEdge(42, 32, 1);
g.addEdge(42, 52, 20);  g.addEdge(52, 42, 1);
g.addEdge(52, 62, 5);  g.addEdge(62, 52, 20);
g.addEdge(62, 72, 1);  g.addEdge(72, 62, 5);
g.addEdge(72, 82, 1);  g.addEdge(82, 72, 1);
g.addEdge(82, 92, 1);  g.addEdge(92, 82, 1);
g.addEdge(92, 102, 20); g.addEdge(102, 92, 1);
g.addEdge(102, 112, 1); g.addEdge(112, 102, 20);
g.addEdge(112, 122, 3); g.addEdge(122, 112, 1);
g.addEdge(122, 132, 3); g.addEdge(132, 122, 3);
g.addEdge(132, 142, 3); g.addEdge(142, 132, 3);

// Column 3
g.addEdge(3, 13, 5);   g.addEdge(13, 3, 1);
g.addEdge(13, 23, 5);  g.addEdge(23, 13, 5);
g.addEdge(23, 33, 5);  g.addEdge(33, 23, 5);
g.addEdge(33, 43, 25);  g.addEdge(43, 33, 5);
g.addEdge(43, 53, 20);  g.addEdge(53, 43, 25);
g.addEdge(53, 63, 25);  g.addEdge(63, 53, 20);
g.addEdge(63, 73, 25);  g.addEdge(73, 63, 25);
g.addEdge(73, 83, 1);  g.addEdge(83, 73, 25);
g.addEdge(83, 93, 1);  g.addEdge(93, 83, 1);
g.addEdge(93, 103, 1); g.addEdge(103, 93, 1);
g.addEdge(103, 113, 3); g.addEdge(113, 103, 1);
g.addEdge(113, 123, 3); g.addEdge(123, 113, 3);
g.addEdge(123, 133, 3); g.addEdge(133, 123, 3);
g.addEdge(133, 143, 5); g.addEdge(143, 133, 3);

// Column 4
g.addEdge(4, 14, 1);   g.addEdge(14, 4, 1);
g.addEdge(14, 24, 5);  g.addEdge(24, 14, 1);
g.addEdge(24, 34, 5);  g.addEdge(34, 24, 5);
g.addEdge(34, 44, 1);  g.addEdge(44, 34, 5);
g.addEdge(44, 54, 3);  g.addEdge(54, 44, 1);
g.addEdge(54, 64, 20);  g.addEdge(64, 54, 1);
g.addEdge(64, 74, 1);  g.addEdge(74, 64, 20);
g.addEdge(74, 84, 5);  g.addEdge(84, 74, 1);
g.addEdge(84, 94, 5);  g.addEdge(94, 84, 5);
g.addEdge(94, 104, 3); g.addEdge(104, 94, 5);
g.addEdge(104, 114, 3); g.addEdge(114, 104, 3);
g.addEdge(114, 124, 5); g.addEdge(124, 114, 3);
g.addEdge(124, 134, 5); g.addEdge(134, 124, 5);
g.addEdge(134, 144, 5); g.addEdge(144, 134, 5);

// Column 5
g.addEdge(5, 15, 5);   g.addEdge(15, 5, 1);
g.addEdge(15, 25, 5);  g.addEdge(25, 15, 5);
g.addEdge(25, 35, 3);  g.addEdge(35, 25, 5);
g.addEdge(35, 45, 5);  g.addEdge(45, 35, 3);
g.addEdge(45, 55, 3);  g.addEdge(55, 45, 5);
g.addEdge(55, 65, 3);  g.addEdge(65, 55, 3);
g.addEdge(65, 75, 0);  g.addEdge(75, 65, 3);
g.addEdge(75, 85, 0);  g.addEdge(85, 75, 0);
g.addEdge(85, 95, 5);  g.addEdge(95, 85, 0);
g.addEdge(95, 105, 5); g.addEdge(105, 95, 5);
g.addEdge(105, 115, 5); g.addEdge(115, 105, 5);
g.addEdge(115, 125, 3); g.addEdge(125, 115, 5);
g.addEdge(125, 135, 3); g.addEdge(135, 125, 3);
g.addEdge(135, 145, 3); g.addEdge(145, 135, 3);

// Column 6
g.addEdge(6, 16, 13);   g.addEdge(16, 6, 5);
g.addEdge(16, 26, 3);  g.addEdge(26, 16, 13);
g.addEdge(26, 36, 5);  g.addEdge(36, 26, 3);
g.addEdge(36, 46, 15);  g.addEdge(46, 36, 5);
g.addEdge(46, 56, 5);  g.addEdge(56, 46, 15);
g.addEdge(56, 66, 3);  g.addEdge(66, 56, 5);
g.addEdge(66, 76, 3);  g.addEdge(76, 66, 3);
g.addEdge(76, 86, 0);  g.addEdge(86, 76, 3);
g.addEdge(86, 96, 5);  g.addEdge(96, 86, 0);
g.addEdge(96, 106, 20); g.addEdge(106, 96, 5);
g.addEdge(106, 116, 20); g.addEdge(116, 106, 20);
g.addEdge(116, 126, 5); g.addEdge(126, 116, 20);
g.addEdge(126, 136, 5); g.addEdge(136, 126, 5);
g.addEdge(136, 146, 3); g.addEdge(146, 136, 5);

// Column 7
g.addEdge(7, 17, 3);   g.addEdge(17, 7, 3);
g.addEdge(17, 27, 5);  g.addEdge(27, 17, 3);
g.addEdge(27, 37, 5);  g.addEdge(37, 27, 3);
g.addEdge(37, 47, 5);  g.addEdge(47, 37, 5);
g.addEdge(47, 57, 3);  g.addEdge(57, 47, 5);
g.addEdge(57, 67, 1);  g.addEdge(67, 57, 3);
g.addEdge(67, 77, 3);  g.addEdge(77, 67, 1);
g.addEdge(77, 87, 5);  g.addEdge(87, 77, 3);
g.addEdge(87, 97, 10);  g.addEdge(97, 87, 5);
g.addEdge(97, 107, 5); g.addEdge(107, 97, 10);
g.addEdge(107, 117, 1); g.addEdge(117, 107, 1);
g.addEdge(117, 127, 1); g.addEdge(127, 117, 1);
g.addEdge(127, 137, 3); g.addEdge(137, 127, 1);
g.addEdge(137, 147, 3); g.addEdge(147, 137, 3);

// Column 8
g.addEdge(8, 18, 15);   g.addEdge(18, 8, 5);
g.addEdge(18, 28, 5);  g.addEdge(28, 18, 15);
g.addEdge(28, 38, 3);  g.addEdge(38, 28, 5);
g.addEdge(38, 48, 3);  g.addEdge(48, 38, 3);
g.addEdge(48, 58, 1);  g.addEdge(58, 48, 3);
g.addEdge(58, 68, 1);  g.addEdge(68, 58, 1);
g.addEdge(68, 78, 1);  g.addEdge(78, 68, 1);
g.addEdge(78, 88, 0);  g.addEdge(88, 78, 1);
g.addEdge(88, 98, 5);  g.addEdge(98, 88, 0);
g.addEdge(98, 108, 1); g.addEdge(108, 98, 5);
g.addEdge(108, 118, 1); g.addEdge(118, 108, 1);
g.addEdge(118, 128, 1); g.addEdge(128, 118, 1);
g.addEdge(128, 138, 1); g.addEdge(138, 128, 1);
g.addEdge(138, 148, 3); g.addEdge(148, 138, 1);

// Column 9
g.addEdge(9, 19, 3);   g.addEdge(19, 9, 5);
g.addEdge(19, 29, 5);  g.addEdge(29, 19, 3);
g.addEdge(29, 39, 1);  g.addEdge(39, 29, 5);
...
g.addEdge(89, 99, 0);  g.addEdge(99, 89, 1);
g.addEdge(99, 109, 1); g.addEdge(109, 99, 0);
